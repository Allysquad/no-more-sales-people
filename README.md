...
The deploy command applies committed migrations, removes old `demo-lead-*` records, and creates 25 fresh randomized demo leads. Real leads are preserved. Run it again after a schema change or whenever you want a clean demo dataset.
